import 'package:petcare/modules/formulario_pet/datasource/formulario_pet_datasource.dart';
...
class FormularioPetModule {
  ...
  static void init() {
    ...
    module.register<FormularioPetDataSource>(
      FormularioPetDataSourceImpl(module.get<FormularioPetService>()),
    );

    module.register<FormularioPetRepository>(
      FormularioPetRepositoryImpl(module.get<FormularioPetDataSource>()),
    );
