...
abstract class HomeService {
  FutureListMap getListaPets(String idUsuario);
}

class HomeServiceImpl implements HomeService {
  final GetServices _get;
  final DeleteServices _delete;
  HomeServiceImpl(this._get, this._delete);

  @override
  FutureListMap getListaPets(String idUsuario) async {
    final urlGet = "${UrlSession.instance.animal}?idTutor=$idUsuario";

    final response = await _get.getRequest(urlGet, {});
